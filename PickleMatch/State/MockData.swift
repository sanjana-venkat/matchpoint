...
enum MockData {
    ...
    static func players() -> [Player] {
        ...
        var people = [
            Player(name: "Maya Chen", gender: .female, age: 29, avatar: Avatar.all[1],
            ...
            Player(name: "Diego Ramirez", gender: .male, age: 34, avatar: Avatar.all[10],
            ...
            Player(name: "Priya Nair", gender: .female, age: 26, avatar: Avatar.all[29],
            ...
            Player(name: "Sam Whitaker", gender: .male, age: 41, avatar: Avatar.all[20],
            ...
            Player(name: "Aisha Khan", gender: .female, age: 31, avatar: Avatar.all[33],
            ...
            Player(name: "Tyler Brooks", gender: .male, age: 23, avatar: Avatar.all[24],
            ...
            Player(name: "Grace Okafor", gender: .female, age: 37, avatar: Avatar.all[25],
            ...
            Player(name: "Leo Martins", gender: .male, age: 28, avatar: Avatar.all[36],
            ...
            Player(name: "Hannah Lee", gender: .female, age: 24, avatar: Avatar.all[37],
            ...
            Player(name: "Marcus Bell", gender: .male, age: 46, avatar: Avatar.all[38],
    ...
    static func conversations(players: [Player]) -> [Conversation] {
        ...
        let requestMessages = [
            "I just moved nearby. Want to play a few games this weekend?",
            "We seem evenly matched — are you free after work Thursday?",
            "A few of us play Saturday mornings. You should join us."
        ]
        for (offset, playerIndex) in [7, 8, 9].enumerated() where players.indices.contains(playerIndex) {
            conversations.append(
                Conversation(
                    partnerId: players[playerIndex].id,
                    sport: .pickleball,
                    messages: [
                        ChatMessage(
                            fromMe: false,
                            kind: .text(requestMessages[offset]),
                            date: Date().addingTimeInterval(TimeInterval(-3_600 * (offset + 1)))
                        )
                    ],
    ...
    static func pendingVerifications(players: [Player]) -> [FaceOff] {
        let venues = ["Zilker Courts", "Riverside Courts", "Austin Pickle Ranch", "Mueller Courts"]
        let scores = [
            ...
            [GameScore(myScore: 9, opponentScore: 11), GameScore(myScore: 12, opponentScore: 10), GameScore(myScore: 11, opponentScore: 6)],
            [GameScore(myScore: 6, opponentScore: 11), GameScore(myScore: 8, opponentScore: 11)]
        ]

        return players.prefix(4).enumerated().map { index, opponent in
            FaceOff(
                sport: .pickleball,
                ...
                proposedByMe: false,
                reportedWinnerByThem: index.isMultiple(of: 2) ? .iWon : .theyWon,
                gameScores: scores[index]
            )
        }
    }
    ...
    static func nearbyCommunities() -> [NearbyCommunity] {
        [
            NearbyCommunity(
                courtID: UUID(uuidString: "10000000-0000-0000-0000-000000000001")!,
                clubID: UUID(uuidString: "20000000-0000-0000-0000-000000000001")!,
                name: "Riverside Pickleball Club",
                description: "Open play, weekly ladders, and friendly competitive sessions.",
            ...
            NearbyCommunity(
                courtID: UUID(uuidString: "10000000-0000-0000-0000-000000000002")!,
                clubID: nil,
                name: "Zilker Park Courts",
                description: "Public outdoor courts with evening lighting.",
            ...
            NearbyCommunity(
                courtID: UUID(uuidString: "10000000-0000-0000-0000-000000000003")!,
                clubID: UUID(uuidString: "20000000-0000-0000-0000-000000000003")!,
                name: "Mueller Open Play",
                description: "Drop-in games for intermediate and advanced players.",
                address: "4550 Mueller Boulevard",
                city: "Austin",
                distanceMiles: 4.6,
                latitude: 30.297,
                longitude: -97.706,
