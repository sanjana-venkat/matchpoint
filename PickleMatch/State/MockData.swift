...
enum MockData {
    ...
    static func players() -> [Player] {
        ...
        var people = [
            Player(name: "Maya Chen", gender: .female, age: 29, avatar: Avatar.all[9],
            ...
            Player(name: "Diego Ramirez", gender: .male, age: 34, avatar: Avatar.all[6],
            ...
            Player(name: "Priya Nair", gender: .female, age: 26, avatar: Avatar.all[4],
            ...
            Player(name: "Sam Whitaker", gender: .male, age: 41, avatar: Avatar.all[3],
            ...
            Player(name: "Aisha Khan", gender: .female, age: 31, avatar: Avatar.all[12],
            ...
            Player(name: "Tyler Brooks", gender: .male, age: 23, avatar: Avatar.all[13],
            ...
            Player(name: "Grace Okafor", gender: .female, age: 37, avatar: Avatar.all[17],
            ...
            Player(name: "Leo Martins", gender: .male, age: 28, avatar: Avatar.all[19],
            ...
            Player(name: "Hannah Lee", gender: .female, age: 24, avatar: Avatar.all[10],
            ...
            Player(name: "Marcus Bell", gender: .male, age: 46, avatar: Avatar.all[11],
